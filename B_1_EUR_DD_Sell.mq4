...
//extern int TP_b=240,SL_b=150,TP_s=260,SL_s=150,Int_Stop=900;
//extern int h_Buy=150,d_Buy=20,h_Sell=80,d_Sell=20;
//23568.86	509	2.03	46.30	1810.76	7.16%	TP_b=240 	SL_b=150 	TP_s=260 	SL_s=150 
//	Int_Stop=900 	h_Buy=150 	d_Buy=20 	h_Sell=80 	d_Sell=20	


//P: 1129126.39	1379	4.30	818.80	199410.11	32.53%	TP_b=280 	SL_b=210 	TP_s=280 	SL_s=200 	
//Int_Stop=800 	h_Buy=100 	d_Buy=5 	h_Sell=100 	d_Sell=4	
...
//dd: 831.71	85	1.11	9.78	1611.08	12.95%	TP=33 	SL=44 	N=15 	Int_Stop=6300	
 ...
 {
    int cnt,MN=1222010;
    int TP_b=240,SL_b=150,TP_s=260,SL_s=150,Int_Stop=900;
    int h_Buy=100,d_Buy=20,h_Sell=80,d_Sell=20;
    double lots=NormalizeDouble(AccountFreeMargin()*0.0001,2);
    if(lots>10)lots=10;if(lots<0.2)lots=0.1;
